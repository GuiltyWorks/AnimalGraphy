...
class UserTest < ActiveSupport::TestCase
  def setup
    ...
    @user_5 = User.new(name: nil, email: "test@example.com", image_name: nil, password: nil)
    @user_6 = User.new(name: nil, email: "test@example.com", image_name: nil, password: "password")
    ...
    @user_8 = User.new(name: nil, email: "test@example.com", image_name: Rack::Test::UploadedFile.new(File.join(Rails.root, "test/fixtures/files/cat.jpg")), password: "password")
    ...
    @user_13 = User.new(name: "test", email: "test@example.com", image_name: nil, password: nil)
    @user_14 = User.new(name: "test", email: "test@example.com", image_name: nil, password: "password")
    @user_15 = User.new(name: "test", email: "test@example.com", image_name: Rack::Test::UploadedFile.new(File.join(Rails.root, "test/fixtures/files/cat.jpg")), password: nil)
    @user_16 = User.new(name: "test", email: "test@example.com", image_name: Rack::Test::UploadedFile.new(File.join(Rails.root, "test/fixtures/files/cat.jpg")), password: "password")
  end
